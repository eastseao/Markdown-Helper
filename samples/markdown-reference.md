...
[File in same folder as the document.](markdownhelper-markdown-reference.md) Use %20 for spaces!
...
This Markdown reference file was created for the [MarkdownHelper](https://github.com/eastseao/markdown-helper) project by [Gregor Santner](gsantner AT mailbox DOT org) and is licensed [Creative Commons Zero 1.0](https://creativecommons.org/publicdomain/zero/1.0/legalcode) (public domain). File revision 4.
