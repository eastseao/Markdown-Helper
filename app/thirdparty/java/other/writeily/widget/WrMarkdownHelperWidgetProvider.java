...
import io.github.eastseao.markdownhelper.activity.MainActivity;
...
public class WrMarkdownHelperWidgetProvider extends AppWidgetProvider {
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (final int appWidgetId : appWidgetIds) {
            ...
            // ~~~Create new File~~~ Share empty text into markdownhelper, easier to access from widget than new file dialog
    ...
    public static void updateLauncherWidgets() {
        ...
        final ComponentName comp = new ComponentName(context, WrMarkdownHelperWidgetProvider.class);
        ...
        context.sendBroadcast(new Intent(context, WrMarkdownHelperWidgetProvider.class)
