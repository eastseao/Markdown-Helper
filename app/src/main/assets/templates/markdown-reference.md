...
This Markdown reference file was created for the [Markdown Helper](https://github.com/eastseao/Markdown-Helper) project by [Gregor Santner](https://github.com/gsanter) and is licensed [Creative Commons Zero 1.0](https://creativecommons.org/publicdomain/zero/1.0/legalcode) (public domain). File revision 3.
