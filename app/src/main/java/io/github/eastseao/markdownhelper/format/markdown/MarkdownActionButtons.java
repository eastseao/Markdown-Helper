...
public class MarkdownActionButtons extends ActionButtonBase {
    ...
    public boolean onActionClick(final @StringRes int action) {
        switch (action) {
            ...
            case R.string.abid_markdown_table_insert_columns: {
                MarkdownHelperDialogFactory.showInsertTableRowDialog(getActivity(), false, this::insertTableRow);
                return true;
            }
    ...
    public boolean onActionLongClick(final @StringRes int action) {
        switch (action) {
            case R.string.abid_markdown_table_insert_columns: {
                MarkdownHelperDialogFactory.showInsertTableRowDialog(getActivity(), true, this::insertTableRow);
                return true;
            }
            case R.string.abid_markdown_code_inline: {
            ...
            case R.string.abid_common_checkbox_list: {
                MarkdownHelperDialogFactory.showDocumentChecklistDialog(
    ...
    public boolean runTitleClick() {
        ...
        MarkdownHelperDialogFactory.showHeadlineDialog(getActivity(), _hlEditor, _webView, _headlineDialogState, (text, start, end) -> {
