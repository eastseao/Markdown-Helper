...
public class StoragePermissionActivity extends MarkdownHelperBaseActivity {
    ...
    public static void requestPermissions(final MarkdownHelperBaseActivity activity) {
