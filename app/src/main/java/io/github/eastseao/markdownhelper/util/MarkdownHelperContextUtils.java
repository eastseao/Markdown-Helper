 ...
 *
#########################################################*/
package io.github.eastseao.markdownhelper.util;
...
import io.github.eastseao.markdownhelper.activity.openeditor.OpenEditorQuickNoteActivity;
import io.github.eastseao.markdownhelper.activity.openeditor.OpenEditorTodoActivity;
import io.github.eastseao.markdownhelper.activity.openeditor.OpenFromShortcutOrWidgetActivity;
import io.github.eastseao.markdownhelper.activity.openeditor.OpenShareIntoActivity;
...
public class MarkdownHelperContextUtils extends GsContextUtils {

    public MarkdownHelperContextUtils(@Nullable final Context context) {
        if (context != null) {
    ...
    public <T extends GsContextUtils> T applySpecialLaunchersVisibility(final Context context, boolean extraLaunchersEnabled) {
        ...
        setLauncherActivityEnabledFromString(context, "io.github.eastseao.markdownhelper.AliasDocumentProcessText", extraLaunchersEnabled);
        return thisp();
    }
