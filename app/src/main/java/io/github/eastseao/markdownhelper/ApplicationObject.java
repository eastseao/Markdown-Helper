 ...
 *
#########################################################*/
package io.github.eastseao.markdownhelper;
...
public class ApplicationObject extends MultiDexApplication {
    ...
    public void onCreate() {
        ...
        // Must be called before any WebView instance is created (see Android docs).
        // Without it WebView (API 21+) only draws the visible viewport, which made
        // "share as image" produce a single screen - or, together with layer type
        // changes, a completely blank picture.
