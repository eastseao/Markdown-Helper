...
import io.github.eastseao.markdownhelper.frontend.AttachLinkOrFileDialog;
...
public class DocumentShareIntoFragment extends MarkdownHelperBaseFragment {
    ...
    public static DocumentShareIntoFragment newInstance(final Intent intent, final Context context) {
        ...
        f.attachment = MarkdownHelperContextUtils.getIntentFile(intent, context);
        return f;
    }
    ...
    public static class ShareIntoImportOptionsFragment extends GsPreferenceFragmentBase<AppSettings> {
        ...
        private void selectOrCreateDestination(final @Nullable File startFolder) {
            ...
            }, getParentFragmentManager(), getActivity(), MarkdownHelperFileBrowserFactory.IsMimeText);
        }
        ...
        private void searchForTarget() {
            ...
            MarkdownHelperDialogFactory.showNotebookFilterDialog(getActivity(), null, filter, (file, isLong) -> {
                if (isLong) {
        ...
        public Boolean onPreferenceClicked(Preference preference, String key, int keyId) {
            final Activity activity = getActivity();
            final String text = _editor.getText().toString();
            final MarkdownHelperContextUtils shu = new MarkdownHelperContextUtils(activity);
            String tmps;
