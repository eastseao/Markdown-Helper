 ...
 *
#########################################################*/
package io.github.eastseao.markdownhelper.format;
...
import io.github.eastseao.markdownhelper.format.asciidoc.AsciidocActionButtons;
import io.github.eastseao.markdownhelper.format.asciidoc.AsciidocSyntaxHighlighter;
import io.github.eastseao.markdownhelper.format.asciidoc.AsciidocTextConverter;
import io.github.eastseao.markdownhelper.format.binary.EmbedBinaryTextConverter;
import io.github.eastseao.markdownhelper.format.csv.CsvSyntaxHighlighter;
import io.github.eastseao.markdownhelper.format.csv.CsvTextConverter;
import io.github.eastseao.markdownhelper.format.keyvalue.KeyValueSyntaxHighlighter;
import io.github.eastseao.markdownhelper.format.keyvalue.KeyValueTextConverter;
import io.github.eastseao.markdownhelper.format.markdown.MarkdownActionButtons;
import io.github.eastseao.markdownhelper.format.markdown.MarkdownReplacePatternGenerator;
import io.github.eastseao.markdownhelper.format.markdown.MarkdownSyntaxHighlighter;
import io.github.eastseao.markdownhelper.format.markdown.MarkdownTextConverter;
import io.github.eastseao.markdownhelper.format.orgmode.OrgmodeActionButtons;
import io.github.eastseao.markdownhelper.format.orgmode.OrgmodeReplacePatternGenerator;
import io.github.eastseao.markdownhelper.format.orgmode.OrgmodeSyntaxHighlighter;
import io.github.eastseao.markdownhelper.format.orgmode.OrgmodeTextConverter;
import io.github.eastseao.markdownhelper.format.plaintext.PlaintextActionButtons;
import io.github.eastseao.markdownhelper.format.plaintext.PlaintextSyntaxHighlighter;
import io.github.eastseao.markdownhelper.format.plaintext.PlaintextTextConverter;
import io.github.eastseao.markdownhelper.format.todotxt.TodoTxtActionButtons;
import io.github.eastseao.markdownhelper.format.todotxt.TodoTxtAutoTextFormatter;
import io.github.eastseao.markdownhelper.format.todotxt.TodoTxtSyntaxHighlighter;
import io.github.eastseao.markdownhelper.format.todotxt.TodoTxtTextConverter;
import io.github.eastseao.markdownhelper.format.wikitext.WikitextActionButtons;
import io.github.eastseao.markdownhelper.format.wikitext.WikitextReplacePatternGenerator;
import io.github.eastseao.markdownhelper.format.wikitext.WikitextSyntaxHighlighter;
import io.github.eastseao.markdownhelper.format.wikitext.WikitextTextConverter;
import io.github.eastseao.markdownhelper.frontend.textview.AutoTextFormatter;
import io.github.eastseao.markdownhelper.frontend.textview.ListHandler;
...
public class FormatRegistry {
    ...
    // File extensions that are known not to be supported by MarkdownHelper
