...
public abstract class MarkdownHelperBaseActivity extends GsActivityBase<AppSettings, MarkdownHelperContextUtils> {
    ...
    @Override
    protected MarkdownHelperContextUtils createContextUtilsInstance() {
        return new MarkdownHelperContextUtils(this);
    }
