...
public abstract class TextConverterBase {
    ...
    // onPageLoaded_markdownhelper_private() invokes the user injected function onPageLoaded()
    protected static final String HTML500_BODY = "</head>\n<body class='" + TOKEN_TEXT_CONVERTER_CSS_CLASS + "' onload='onPageLoaded_markdownhelper_private();'>\n\n<!-- USER DOCUMENT CONTENT -->\n\n\n";
    /**
    ...
    protected static final String HTML_ON_PAGE_LOAD_S = "<script> function onPageLoaded_markdownhelper_private() {\n";
