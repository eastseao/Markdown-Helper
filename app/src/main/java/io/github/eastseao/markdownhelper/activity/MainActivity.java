...
import io.github.eastseao.markdownhelper.frontend.NewFileDialog;
...
public class MainActivity extends MarkdownHelperBaseActivity implements GsFileBrowserFragment.FilesystemFragmentOptionsListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        _cu = new MarkdownHelperContextUtils(this);
        ...
        // NOTE: the "rate this app" pop-up (optShowRate) is intentionally not shown any more -
        // it appeared while opening the app and asking the user to rate was not wanted.
        ...
        _startFolder = MarkdownHelperContextUtils.getValidIntentFile(intent, fallback);
    ...
    public void onActivityFirstTimeVisible() {
        ...
        if (startTab != R.id.nav_notebook && MarkdownHelperContextUtils.getValidIntentFile(getIntent(), null) == null) {
    ...
    protected void onNewIntent(final Intent intent) {
        ...
        final File file = MarkdownHelperContextUtils.getValidIntentFile(intent, null);
    ...
    // "Rate this app" was requested to be removed - see onCreate(). The helper is kept (unused)
    // so the library dependency does not have to be touched for this change.
    ...
    public GsFileBrowserOptions.Options getFilesystemFragmentOptions(GsFileBrowserOptions.Options existingOptions) {
        if (_filesystemDialogOptions == null) {
            _filesystemDialogOptions = MarkdownHelperFileBrowserFactory.prepareFsViewerOpts(this, false, new GsFileBrowserOptions.SelectionListenerAdapter() {
